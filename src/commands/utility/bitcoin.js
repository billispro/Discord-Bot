...
module.exports = {
    data: new SlashCommandBuilder()
        .setName('bitcoin')
        .setDescription('Get real-time Bitcoin information')
    ...
    async execute(interaction) {
        ...
        try {
            ...
            const { data } = await axios.get('https://api.coingecko.com/api/v3/coins/bitcoin?localization=false&tickers=false&market_data=true&community_data=true&developer_data=false&sparkline=true');
            ...
            const embed = new EmbedBuilder()
                ...
                .setTitle(`Bitcoin (BTC) Information ${priceChangeEmoji}`)
                ...
                .addFields(
                    ...
                    },
                    {
                        ...
                        value: `${formatNumber(data.market_data.circulating_supply)} BTC`,
                        inline: true
                    },
                    {
                        name: '🌐 Max Supply',
                        value: `${formatNumber(data.market_data.max_supply)} BTC`,
                        inline: true
                    }
                )
                .addFields(
            ...
            await interaction.editReply({
                content: '❌ Error fetching Bitcoin data. Please try again later.',
                ephemeral: true
            });
        }
    }
