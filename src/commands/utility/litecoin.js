...
module.exports = {
    data: new SlashCommandBuilder()
        .setName('litecoin')
        .setDescription('Get real-time Litecoin information')
    ...
    async execute(interaction) {
        ...
        try {
            ...
            const { data } = await axios.get('https://api.coingecko.com/api/v3/coins/litecoin?localization=false&tickers=false&market_data=true&community_data=true&developer_data=false&sparkline=true');
            ...
            const embed = new EmbedBuilder()
                ...
                .setTitle(`Litecoin (LTC) Information ${priceChangeEmoji}`)
                ...
                .addFields(
                    ...
                    },
                    {
                        ...
                        value: `${formatNumber(data.market_data.circulating_supply)} LTC`,
                        inline: true
                    },
                    {
                        name: '🌐 Max Supply',
                        value: `${formatNumber(data.market_data.max_supply)} LTC`,
                        inline: true
                    }
                )
                .addFields(
            ...
            await interaction.editReply({
                content: '❌ Error fetching Litecoin data. Please try again later.',
                ephemeral: true
            });
        }
    }
